...
class LevelFour(GameMode):
    def __init__(self,parent):
        ...
        self.parent.AddCode(code.NumberGenerator(1)(self.parent,Point(0.38,0.33),drawing.constants.colours.white))
        self.parent.AddCode(code.NumberGenerator(1)(self.parent,Point(0.38,0.30),drawing.constants.colours.white))
        self.parent.AddCode(code.NumberGenerator(1)(self.parent,Point(0.38,0.27),drawing.constants.colours.white))
        self.parent.AddCode(code.NumberGenerator(1)(self.parent,Point(0.38,0.24),drawing.constants.colours.white))
