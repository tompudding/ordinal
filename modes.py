...
class Titles(Mode):
    ...
    def __init__(self, parent):
        ...
        self.last = 0
        pygame.mixer.music.load(globals.pyinst.path("titles.ogg"))
...
class LevelOne(GameMode):
    def __init__(self, parent):
        ...
        self.source = codey.NumberGenerator(1)(self.parent, Point(0.38, 0.4), drawing.constants.colours.white)
        self.sink = codey.TwoSong(self.parent, Point(0.52, 0.39), drawing.constants.colours.white)
        self.parent.AddCode(self.source)
        self.parent.AddCode(self.sink)
        self.parent.Play(None)
        pygame.mixer.music.load(globals.pyinst.path("ticks.ogg"))
        pygame.mixer.music.play(-1)
...
class LevelTwo(GameMode):
    def __init__(self, parent):
        ...
        self.parent.AddCode(
            codey.NumberGenerator(2)(self.parent, Point(0.38, 0.45), drawing.constants.colours.white)
        )
        self.parent.AddCode(
            codey.NumberGenerator(3)(self.parent, Point(0.38, 0.4), drawing.constants.colours.white)
        )
        self.parent.AddCode(
            codey.NumberGenerator(5)(self.parent, Point(0.38, 0.35), drawing.constants.colours.white)
        )
        self.parent.AddCode(
            codey.AlternateSong(self.parent, Point(0.52, 0.39), drawing.constants.colours.white)
        )
        self.parent.Play(None)
        pygame.mixer.music.play(-1)
...
class LevelThree(GameMode):
    def __init__(self, parent):
        ...
        self.parent.AddCode(
            codey.ArithmeticSource(self.parent, Point(0.38, 0.45), drawing.constants.colours.white)
        )
        self.parent.AddCode(
            codey.ArithmeticSource(self.parent, Point(0.38, 0.4), drawing.constants.colours.white)
        )
        self.parent.AddCode(codey.Two2Song(self.parent, Point(0.52, 0.39), drawing.constants.colours.white))
        self.parent.Play(None)
        pygame.mixer.music.play(-1)
...
class LevelFour(GameMode):
    def __init__(self, parent):
        ...
        self.parent.AddCode(
            codey.NumberGenerator(0xEA3C)(self.parent, Point(0.38, 0.51), drawing.constants.colours.white)
        )
        self.parent.AddCode(
            codey.NumberGenerator(0x50A1)(self.parent, Point(0.38, 0.48), drawing.constants.colours.white)
        )
        self.parent.AddCode(
            codey.NumberGenerator(0x9361)(self.parent, Point(0.38, 0.45), drawing.constants.colours.white)
        )
        self.parent.AddCode(
            codey.NumberGenerator(0xEA3D)(self.parent, Point(0.38, 0.42), drawing.constants.colours.white)
        )

        self.parent.AddCode(codey.PowerSong(self.parent, Point(0.52, 0.39), drawing.constants.colours.white))
        self.parent.Play(None)
        pygame.mixer.music.play(-1)
...
class LevelFourIntro(LevelTwoIntro):
    blurb = (
        "You used {num_symbols} code blocks and took {cycles} cycles. This next level is a bit tricky. Sorry"
    )
